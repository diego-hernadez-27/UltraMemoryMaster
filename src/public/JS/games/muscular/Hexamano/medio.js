...
class Juego{
    ...
    iniciar(){
        ...
        this.generador=window.setInterval(this.generarPalabra.bind(this),800); /*mas palabras juntas*/
        this.animador=window.setInterval(this.vista.moverPalabra.bind(this.vista), 60); /*la rapides de la spalabras */
...
class Modelo{
    constructor(){
        this.palabras=["Hola", "gato", "pala", "pala",
        "lona", "comida", "comer", "papas", "recreo", "teclado", "escribir",
        "leer", "libro", "papel", "ofrecer", "perico"];
        this.puntuacion=0;
        this.vidas=3;
    }
    crearPalabra(){
