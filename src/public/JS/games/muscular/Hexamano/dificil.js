...
class Juego{
    ...
    iniciar(){
        ...
        this.generador=window.setInterval(this.generarPalabra.bind(this),500); /*mas palabras juntas*/
        this.animador=window.setInterval(this.vista.moverPalabra.bind(this.vista), 30); /*la rapides de la spalabras */
